...
話し方について(ここが重要です):
- ニュース原稿やアナウンサーの読み上げのような硬い文体は避けてください。
  友人同士が雑談しながらニュースを紹介するような、くだけた自然な話し言葉に
  してください(です/ます調でも構いませんが、機械的に整った文にしない)。
- 「えー」「あー」「そうなんですよ」「なるほどですね」「へえ、それは」
  「〜みたいで」「〜らしいんですけど」のような、実際の会話にある相槌・
  フィラー・言い淀みを自然な範囲で織り交ぜてください。
- 毎ターン同じような文型(「〜ですね」「〜と思います」の繰り返し)になら
  ないよう、語尾や言い回しにバリエーションを持たせてください。
- Bはただ相槌を打つだけでなく、時々驚いたり、素朴な疑問をぶつけたり、
  自分の感想を挟んだりして、一方通行の説明にならないようにしてください。
- 箇条書き・記号・絵文字は使わない(音声合成にそのまま読み上げられます)。
