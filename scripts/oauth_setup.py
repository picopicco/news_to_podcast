...
Prerequisites:
  1. In Google Cloud Console > Google Auth Platform > Audience:
     Publishing status = "In production" (NOT "Testing" -- Testing apps
     get their refresh tokens revoked after 7 days).
...
A browser window opens for you to sign in and consent. The refresh token
